...
1.  James, G., Witten, D., Hastie, T., & Tibshirani, R. (2021). An
    introduction to statistical learning (2nd ed.) \[PDF\]. Springer.
2.  Boehmke, Brad, and Brandon M. Greenwell. Hands-on machine learning
    with R. Boca Raton, FL: CRC Press, 2020. Print.
3.  [Classification with Tidymodels, Workflows and Recipes \| Jan
    Kirenz](https://www.kirenz.com/post/2021-02-17-r-classification-tidymodels/)
4.  https://www.tmwr.org/splitting.html
